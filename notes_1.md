* [NOTES 1 FILE](#notes-1-file)
   ...
   * [javascript performans avantajı nereden kaynaklı?](#javascript-performans-avantajı-nereden-kaynaklı)
   * [sunucudaki performans üstünlüğü](#sunucudaki-performans-üstünlüğü)
   * [performans comparison: single-thread non-blocking I/O vs multithread blocking-IO](#performans-comparison-single-thread-non-blocking-io-vs-multithread-blocking-io)
   * [moment.js](#momentjs)
   ...
   * ["main" inside package.json](#main-inside-packagejson)
   * [npm install](#npm-install)
   * [npm install -g module1](#npm-install--g-module1)
   * [npm list](#npm-list)
   * [directory structure](#directory-structure)
   * [npm link module1](#npm-link-module1)
   * [scripts](#scripts)
   * [package-lock.json](#package-lockjson)
   * [npm-shrinkwrap.json](#npm-shrinkwrapjson)
   * [--no-shrinkwrap](#--no-shrinkwrap)
   * [--save (yada -S)](#--save-yada--s)
   * [npx](#npx)
   * [scoped packages](#scoped-packages)
   * [nodejs](#nodejs)
      * [express](#express)
      * [REPL](#repl)
   * [yarn vs bower](#yarn-vs-bower)
   * [Gulp vs Grunt](#gulp-vs-grunt)
   * [how to use common static string variables](#how-to-use-common-static-string-variables)
   * [javascript core ile obje klonlama](#javascript-core-ile-obje-klonlama)
   * [Jquery ile obje klonlama](#jquery-ile-obje-klonlama)
   * [reactJS](#reactjs)
   * [jsx](#jsx)
   * [page navigation](#page-navigation)
      * [react-router](#react-router)
      * [react-router-redux (yada eski adı:redux-simple-router)](#react-router-redux-yada-eski-adıredux-simple-router)
      * [react-native-router-flux](#react-native-router-flux)
      * [react-navigation vs react-native-navigation](#react-navigation-vs-react-native-navigation)
         * [react-navigation](#react-navigation)
         * [react-native-navigation](#react-native-navigation)
      * [NavigatorIOS](#navigatorios)
      * [createStackNavigator vs createSwitchNavigator](#createstacknavigator-vs-createswitchnavigator)
      * [history](#history)
      * [react-history](#react-history)
   * [setState()](#setstate)
   * [forceUpdate()](#forceupdate)
   * [component objesi metodları (lifecycle)](#component-objesi-metodları-lifecycle)
            * [sayfa render olurken bir component'in sırası ile aşağıdaki metodları çağrılır:](#sayfa-render-olurken-bir-componentin-sırası-ile-aşağıdaki-metodları-çağrılır)
            * [Bir componentin state'inin yada props'unun değişmesiyle tekrardan render edilmesi sonucu çağrılan methodlardır:](#bir-componentin-stateinin-yada-propsunun-değişmesiyle-tekrardan-render-edilmesi-sonucu-çağrılan-methodlardır)
            * [Komponent yok edilirken çalıştırılacak metod:](#komponent-yok-edilirken-çalıştırılacak-metod)
   * [prop vs state](#prop-vs-state)
   * [defaultProps](#defaultprops)
   * [props.children](#propschildren)
   * [propType](#proptype)
   * [controlled vs uncontrolled component](#controlled-vs-uncontrolled-component)
   * [componentwillmount mı? componentdidmount mı? ajax call için uygun?](#componentwillmount-mı-componentdidmount-mı-ajax-call-için-uygun)
   * [container vs component](#container-vs-component)
   * [fonksiyon call bindings](#fonksiyon-call-bindings)
   * [Fonksiyonel bileşen (yada functional component) vs class component (yada sınıf bileşen)](#fonksiyonel-bileşen-yada-functional-component-vs-class-component-yada-sınıf-bileşen)
   ...
   * [Reconciliation (yada uyumlaştırma)](#reconciliation-yada-uyumlaştırma)
   * [shadow Dom](#shadow-dom)
   * [Virtual DOM for react native](#virtual-dom-for-react-native)
   * [react activity](#react-activity)
   * [native koda erişme](#native-koda-erişme)
   * [native-base](#native-base)
   * [react-devtools](#react-devtools)
   * [react-native-debugger](#react-native-debugger)
   * [hot reload vs live reload](#hot-reload-vs-live-reload)
   * [npm start -- --reset-cache](#npm-start------reset-cache)
   * [metro bundler](#metro-bundler)
   * [ref](#ref)
   * [react için bazı best practice'ler/notlar](#react-için-bazı-best-practicelernotlar)
   * ["react-native link" komutu](#react-native-link-komutu)
   * [react-native-cli vs react-native](#react-native-cli-vs-react-native)
   * [react vs react-dom vs react-native](#react-vs-react-dom-vs-react-native)
   * [RNPM (yada react native package manager)](#rnpm-yada-react-native-package-manager)
   * [react dizin yapısı](#react-dizin-yapısı)
   * [create-react-app](#create-react-app)
   * [<a href="https://github.com/react-boilerplate/react-boilerplate">https://github.com/react-boilerplate/react-boilerplate</a>](#httpsgithubcomreact-boilerplatereact-boilerplate)
   * [watchman](#watchman)
   * [modernizr](#modernizr)
   ...
   * [global vs local variable](#global-vs-local-variable)
   * [=== vs ==](#-vs-)
   * [NaN](#nan)
   ...
   * [closure (yada lexical closure yada function closure)](#closure-yada-lexical-closure-yada-function-closure)
   * [fonksiyon ve obje içinde gelen property ve metodlar](#fonksiyon-ve-obje-içinde-gelen-property-ve-metodlar)
            * [fonksiyon properties:](#fonksiyon-properties)
            * [fonksiyon metods:](#fonksiyon-metods)
            * [objelerin içerdiği fonksiyonlar:](#objelerin-içerdiği-fonksiyonlar)
   * [accessor property](#accessor-property)
   * [multi equal character on same line](#multi-equal-character-on-same-line)
   * [js'te bir syntax örneği](#jste-bir-syntax-örneği)
   * [amd (Asynchronous Module Definition) vs commonjs](#amd-asynchronous-module-definition-vs-commonjs)
   * [require.js](#requirejs)
   * [libary oluştuturken genelde yapılan tanımlamalar:](#libary-oluştuturken-genelde-yapılan-tanımlamalar)
   * [web page lifecycle](#web-page-lifecycle)
            * [events](#events)
            * [readystate](#readystate)
            * [eventler ile gili notlar](#eventler-ile-gili-notlar)
   * [$ prefix on variables](#-prefix-on-variables)
   * [namespace](#namespace)
   * [yield keyword](#yield-keyword)
   * [yield*](#yield)
   * [yield ile hiçbir şey döndürülmediğinde ne olur?](#yield-ile-hiçbir-şey-döndürülmediğinde-ne-olur)
   * [generator nasıl done=true olduğunu anlıyor?](#generator-nasıl-donetrue-olduğunu-anlıyor)
   * [var iterator = g2();](#var-iterator--g2)
   * [yield kullanılan fonksiyonlarda return keywordü](#yield-kullanılan-fonksiyonlarda-return-keywordü)
   * [noConflict metodları](#noconflict-metodları)
   * [arrays](#arrays)
            * [obje'den türemiştir.](#objeden-türemiştir)
            * [erişmek için:](#erişmek-için)
            * [array'in hazır metodları:](#arrayin-hazır-metodları)
   * [For loop comparison table](#for-loop-comparison-table)
            * [Tablo hakkında](#tablo-hakkında)
   * [class](#class)
   * [ecmascript vs javascript vs jscript vs ActionScript](#ecmascript-vs-javascript-vs-jscript-vs-actionscript)
   * [CoffeeScript vs typescript](#coffeescript-vs-typescript)
   * [source-to-source compiler (yada transcompiler yada transpiler)](#source-to-source-compiler-yada-transcompiler-yada-transpiler)
   * [typescript version history](#typescript-version-history)
   * [ECMAScript](#ecmascript)
   * [ECMAScript (yada ES) version history](#ecmascript-yada-es-version-history)
   * [ecmascript implementasyonları standardize edilirken, her sürüm kendi içinde belli sürümlere ayrılır.](#ecmascript-implementasyonları-standardize-edilirken-her-sürüm-kendi-içinde-belli-sürümlere-ayrılır)
   * [babel](#babel)
   * [.babelrc json vs babel.config.js](#babelrc-json-vs-babelconfigjs)
   * [babel plugins](#babel-plugins)
   * [@babel/preset-env](#babelpreset-env)
   * [Babel 6 "loose" mode](#babel-6-loose-mode)
   * [ES2017 ile gelen bazı yenilikler](#es2017-ile-gelen-bazı-yenilikler)
            * [async ve await keywordleri](#async-ve-await-keywordleri)
            * [Object.values()](#objectvalues)
            * [Object.values()](#objectvalues-1)
            * [Object.getOwnPropertyDescriptors()](#objectgetownpropertydescriptors)
   * [ES2016 ile gelen bazı yenilikler](#es2016-ile-gelen-bazı-yenilikler)
            * [Exponentiation Operator](#exponentiation-operator)
   * [ES2015 ile gelen bazı yenilikler](#es2015-ile-gelen-bazı-yenilikler)
            * [Default Parameter Values](#default-parameter-values)
            * [class yapıları (extend, constructor desteği ile)](#class-yapıları-extend-constructor-desteği-ile)
            * [let operatörü. (Block-Scoped Variables)](#let-operatörü-block-scoped-variables)
            * [const keyword](#const-keyword)
            * [Template literals (yada Template strings)](#template-literals-yada-template-strings)
            * [String format](#string-format)
         * [Set liste türü](#set-liste-türü)
            * [Iterators](#iterators)
            * [Maps](#maps)
            * [WeakMap](#weakmap)
            * [is ve isnt operatörü](#is-ve-isnt-operatörü)
            * [Destructuring Assignment](#destructuring-assignment)
            * [sınırsız parametre](#sınırsız-parametre)
            * [Expression Bodies](#expression-bodies)
            * [parametre birleştirme](#parametre-birleştirme)
            * [parantezsiz metod çağırma işlemi](#parantezsiz-metod-çağırma-işlemi)
            * [direct support for octal and binary](#direct-support-for-octal-and-binary)
            * [Property Shorthand](#property-shorthand)
            * [module Value Export/Import](#module-value-exportimport)
            * [sınıf içindeki metodlara static operatörü geldi](#sınıf-içindeki-metodlara-static-operatörü-geldi)
            * [generators (yield keywordü)](#generators-yield-keywordü)
            * [promise nesnesi geldi](#promise-nesnesi-geldi)
   * [Browser Object Model (yada BOM)](#browser-object-model-yada-bom)
      * [window](#window)
      ...
      * [document](#document)
   * [jquery object (yada jQuery collection object)](#jquery-object-yada-jquery-collection-object)
   * [javascript executes code in 3 phases](#javascript-executes-code-in-3-phases)
   * [WEB](#web)
   * [Web Hypertext Application Technology Working Group (yada WHATWG)](#web-hypertext-application-technology-working-group-yada-whatwg)
   * [WebAssembly (yada Wasm)](#webassembly-yada-wasm)
   * [postback](#postback)
   * [REST Resource Naming](#rest-resource-naming)
   * [placeholder](#placeholder)
   * [carousel](#carousel)
   * [Favicon](#favicon)
   * [access inside html popup with pure (core) js](#access-inside-html-popup-with-pure-core-js)
   * [Backlink](#backlink)
   * [tampermonkey vs greasemonkey vs Violentmonkey](#tampermonkey-vs-greasemonkey-vs-violentmonkey)
   * [chart.js](#chartjs)
   * [d3](#d3)
   * [jqplot](#jqplot)
   * [çizge (yada graph yada grafik yada tr:graf yada çizit)](#çizge-yada-graph-yada-grafik-yada-trgraf-yada-çizit)
   * [chart](#chart)
   * [diagram (yada tr:diyagram)](#diagram-yada-trdiyagram)
   * [Cartogram (yada kartogram)](#cartogram-yada-kartogram)
   * [indicator (yada indikatör)](#indicator-yada-indikatör)
   * [flux](#flux)
   * [redux](#redux)
   * [genel metodlar](#genel-metodlar)
   * [store objesi](#store-objesi)
   * [enhancer](#enhancer)
   * [react-redux](#react-redux)
   * [Redux Thunk vs Redux Promise vs Saga](#redux-thunk-vs-redux-promise-vs-saga)
   * [redux middleware](#redux-middleware)
   * [Saga](#saga)
   * [gerçek çalışan saga örneği](#gerçek-çalışan-saga-örneği)
   * [redux araçları](#redux-araçları)
   * [Web Debugging Proxy Application](#web-debugging-proxy-application)
   * [Temel çalışma mantığı](#temel-çalışma-mantığı)
   * [localhost problemi](#localhost-problemi)
   * [Web Debugging Proxy Application'lerin SSL bağlantılarını izlemesi](#web-debugging-proxy-applicationlerin-ssl-bağlantılarını-izlemesi)
   * [mitmproxy modes](#mitmproxy-modes)
   * [Transparent Proxying (yada intercepting proxy yada inline proxy yada forced proxy)](#transparent-proxying-yada-intercepting-proxy-yada-inline-proxy-yada-forced-proxy)
   * [Cascading Style Sheets (yada CSS)](#cascading-style-sheets-yada-css)
   * [sürümleri](#sürümleri)
   * [Bir HTML Objenin kenarların propertieleri (bölümleri)](#bir-html-objenin-kenarların-propertieleri-bölümleri)
   * [outline](#outline)
   * [display property](#display-property)
   * [div vs span](#div-vs-span)
   * [position propertie](#position-propertie)
   * [z-index](#z-index)
   * [overflow](#overflow)
   * [transform](#transform)
   ...
   * [farklı yazım şekilleri](#farklı-yazım-şekilleri)
   ...
   * [DOM Events](#dom-events)
            ...
            * [Frame/Object Events](#frameobject-events)
            * [Form Object events](#form-object-events)
   ...
   * [event object](#event-object)
            * [propertie'ler](#propertieler)
            * [metod'lar](#metodlar)
   * [http headers](#http-headers)
   * [header isimlendirmesi](#header-isimlendirmesi)
   * [relative quality factor](#relative-quality-factor)
   * [header'lar cookieleri barındırır](#headerlar-cookieleri-barındırır)
   * [upload file](#upload-file)
   * [download file](#download-file)
   * [multipart/alternative vs multipart/mixed](#multipartalternative-vs-multipartmixed)
   * [chunked http request](#chunked-http-request)
   * [chunked vs multipart](#chunked-vs-multipart)
   * [http version history](#http-version-history)
   * [HTTP 1.1 vs HTTP 2](#http-11-vs-http-2)
   * [SPDY](#spdy)
   * [http request methods](#http-request-methods)
   * [conditional requests](#conditional-requests)
   * [strong ve weak validator](#strong-ve-weak-validator)
   * [cache ile ilgili header'lar](#cache-ile-ilgili-headerlar)
            * [Cache-Control (eski sürüm http'lerde "Pragma"):](#cache-control-eski-sürüm-httplerde-pragma)
            * [ETag](#etag)
            * [If-Match](#if-match)
   ...
   * [xhtml (yada Extensible HyperText Markup Language)](#xhtml-yada-extensible-hypertext-markup-language)
   * [DHTML (yada Dynamic HTML)](#dhtml-yada-dynamic-html)
   * [HTML DOM Levels](#html-dom-levels)
   * [cookie security policy](#cookie-security-policy)
   * [cookies properties](#cookies-properties)
   * [third party cookie vs first party cookie](#third-party-cookie-vs-first-party-cookie)
   * [media file transfer cookies](#media-file-transfer-cookies)
   * [firefox and chrome cookie management](#firefox-and-chrome-cookie-management)
   * [Diğer sitelere login olup olmadığı bilgisini edinme](#diğer-sitelere-login-olup-olmadığı-bilgisini-edinme)
   * [Content Blocking (yada eski adı:tracking protection (yada eski adı:izlenme koruması))](#content-blocking-yada-eski-adıtracking-protection-yada-eski-adıizlenme-koruması)
   * [mixed content](#mixed-content)
   * [XSS (Cross Site Scripting)](#xss-cross-site-scripting)
   * [Stored XSS (AKA Persistent or Type I)](#stored-xss-aka-persistent-or-type-i)
   * [Reflected XSS (AKA Non-Persistent or Type II)](#reflected-xss-aka-non-persistent-or-type-ii)
   * [DOM Based XSS (AKA Type-0)](#dom-based-xss-aka-type-0)
   * [HTML character entities](#html-character-entities)
   * [CSRF (yada Cross-Site Request Forgery yada XSRF)](#csrf-yada-cross-site-request-forgery-yada-xsrf)
   * [CSRF vs XSS](#csrf-vs-xss)
   * [chrome guest mode vs private mode](#chrome-guest-mode-vs-private-mode)
   * [firefox profiles](#firefox-profiles)
   * [Multi-Account Containers](#multi-account-containers)
   * [adblock vs adblock plus](#adblock-vs-adblock-plus)
   * [uBlock Origin vs uMatrix](#ublock-origin-vs-umatrix)
   * [noscript](#noscript)
   * [ghostery](#ghostery)
   * [WOT (yada Web of Trust yada myWOT)](#wot-yada-web-of-trust-yada-mywot)
   * [addblocker web sitemizdeki bir kaynağı engellerse ne yapmalıyız?](#addblocker-web-sitemizdeki-bir-kaynağı-engellerse-ne-yapmalıyız)
   * [add blocker'a yakalanmamak için ne yapılmalıdır](#add-blockera-yakalanmamak-için-ne-yapılmalıdır)
   * [add blocker'ı algılamak](#add-blockerı-algılamak)
